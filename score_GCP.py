...
conn = sqlite3.connect('/root/sentiment-main/reuters.db')
cursor = conn.cursor()
...
conn_sentiment = sqlite3.connect('/root/sentiment-main/news_sentiment.db')
...
llm = Llama(
    model_path = r"/root/sentiment-main/Llama-3-Instruct-8B-SPPO-Iter3-Q5_K_M.gguf",
    n_gpu_layers = -1,
    seed = 123,
    n_ctx = 8192,
    verbose = False
